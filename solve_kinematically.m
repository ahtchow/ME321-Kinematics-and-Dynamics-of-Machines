function [link3_info] = solve_kinematically(theta_2, R, theta_2_dot, theta_2_ddot)
...
Input: theta_2 = [0 ... 2π], R = [r1, r2, r_bc, r4], theta_2_dot, theta_2_ddot
...
theta_3_ddot = (1./r3) .* ( (-r2 * theta_2_ddot .* cosd(theta_2-theta_3)) ...
                + (r2 * (theta_2_dot)^2 .* sind(theta_2-theta_3)) - (2* r3_dot .* theta_3_dot));
